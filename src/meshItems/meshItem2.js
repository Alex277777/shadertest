...
import vertex from '/src/glsl2/vertex.glsl';
import fragment from '/src/glsl2/fragment.glsl';
...
class MeshItem0 {
    ...
    render(velocity = 0, mouseCoordinates, selectMesh) {
        ...
        // this.uniforms.uTexture1.value = this.imgsLoaded[this.currentSlide]
        // this.uniforms.uTexture2.value = this.imgsLoaded[this.nextSlide]
