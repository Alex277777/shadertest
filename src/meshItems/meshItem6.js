...
import vertex from '/src/glsl6/vertex.glsl';
import fragment from '/src/glsl6/fragment.glsl';
...
import displacment from '/src/assets/img/noise6.jpg';
...
class MeshItem0 {
    ...
    createMesh() {
        const geometry = new THREE.PlaneGeometry(1, 1, 130, 100);
