...
import vertex from '/src/glsl8/vertex.glsl';
import fragment from '/src/glsl8/fragment.glsl';
import image1 from '/src/assets/img/vodopad.jpg';
import image2 from '/src/assets/img/vodopad_mask.jpg';
import image3 from '/src/assets/img/noise6.jpg';
...
class MeshItem0 {
    ...
    createMesh() {
        const geometry = new THREE.PlaneGeometry(1, 1, 130, 110);
        ...
        this.imageTexture4 = new THREE.TextureLoader().load(this.images[3]);
